...
import cafe.ferret.mc.earlydays.mixin.MatchingStackAccessor;
import cafe.ferret.mc.earlydays.mixin.RecipeFieldAccessor;
...
public class RecipeRemover {
    public static void removeRecipe() {
        ServerLifecycleEvents.SERVER_STARTED.register(server -> {
            ...
            removeRecipes(mgr, EarlyDaysTags.VANILLA_TOOLS);
        });
    }
    ...
    private static int removeRecipes(final RecipeManager recipeManager, final Predicate<Recipe<?>> predicate) {
        ...
        existingRecipes = ((RecipeFieldAccessor) recipeManager).getRecipeField();
